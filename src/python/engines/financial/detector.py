"""Build the financial-structure-v1 model from prepared text lines.
...
DETECTOR_VERSION = "financial-structure-detector-1"
...
def detect_financial_structure(
    ...
    *,
    ...
    return FinancialStructure(model=model, spans=tuple(spans))
