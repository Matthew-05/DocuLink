...
/** Original Talliark layered-document artwork used for document onboarding. */
export function createDocumentIcon(): SVGSVGElement {
  const icon = createIcon("talliark-icon talliark-icon--document", "0 0 120 112");

  const halo = createSvgElement("circle", {
    class: "talliark-icon__halo",
    cx: "57",
    cy: "59",
    r: "47",
  });
  ...
  const backPage = createSvgElement("rect", {
    class: "talliark-icon__back-page",
    height: "76",
    rx: "10",
  ...
  const fold = createSvgElement("path", {
    class: "talliark-icon__fold",
    d: "M70 11v16.5h16.5",
  });

  const lines = createSvgElement("g", { class: "talliark-icon__document-lines" });
  lines.append(
...
/** Original Talliark stacked-folder glyph used for Manage Files actions. */
export function createManageFilesIcon(): SVGSVGElement {
  const icon = createIcon("talliark-icon talliark-icon--manage-files", "0 0 24 24");
  icon.append(
    createSvgElement("path", {
      class: "talliark-icon__folder-back",
      d: "M5.25 5.25h5l1.7 2H20v9.5H5.25Z",
    }),
    createSvgElement("path", {
      class: "talliark-icon__folder-middle",
      d: "M3.25 7.5h5l1.7 2H18v9.25H3.25Z",
    }),
    createSvgElement("path", {
      class: "talliark-icon__folder-front",
