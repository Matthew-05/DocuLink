...
namespace DocuLink.Addin.Modules.Services.Conversion
{
    ...
    /// folder under %TEMP%\DocuLink\convert and deletes the whole folder on dispose,
    ...
    {
        private const string RootFolderName = "DocuLink";
        ...
        public void DeleteNow(string path)
        {
            ...
            {
                DocuLinkLog.Trace($"ConversionTempStore could not delete '{path}': {ex.Message}");
            }
        ...
        private void SweepOrphans()
        {
            ...
            {
                DocuLinkLog.Trace($"ConversionTempStore sweep failed: {ex.Message}");
            }
        }
        ...
        public void Dispose()
        {
            ...
            {
                DocuLinkLog.Trace($"ConversionTempStore could not delete '{_sessionDir}': {ex.Message}");
            }
