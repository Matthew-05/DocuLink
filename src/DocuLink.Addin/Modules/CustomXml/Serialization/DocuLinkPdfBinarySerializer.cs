...
namespace DocuLink.Addin.Modules.CustomXml.Serialization
{
    internal static class DocuLinkPdfBinarySerializer
    {
            ...
            string tableStructureBase64)
        {
            ...
            if (!string.IsNullOrEmpty(tableStructureBase64))
                root.Add(new XElement(ns + DocuLinkXml.TableStructureBase64ElementName, tableStructureBase64));
            ...
            out string tableStructureBase64)
        {
            ...
            string tables = root.Element(ns + DocuLinkXml.TableStructureBase64ElementName)?.Value;
            tableStructureBase64 = string.IsNullOrEmpty(tables) ? null : tables;
        }
    }
}
