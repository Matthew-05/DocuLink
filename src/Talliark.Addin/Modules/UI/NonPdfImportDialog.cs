...
namespace Talliark.Addin.Modules.UI
{
    ...
    /// of them Talliark can convert (checkable, one row per extension with a count),
    ...
    internal sealed class NonPdfImportDialog : Form
    {
            ...
            IList<ImportFormatSummary> unsupported)
        {
            ...
            Text = "Talliark — Convert documents";
            ...
            IList<ImportFormatSummary> unsupported)
        {
            ...
            string text =
                ...
                " Talliark converts supported documents to PDF for workbook storage.";
