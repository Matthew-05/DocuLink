...
{
    /// <summary>
    /// Parses inbound document-linker→host JSON messages.
    /// </summary>
    internal static class DocumentLinkerMessageParser
    {
        public static string GetMessageType(string json) =>
            WebMessageParser.GetMessageType(json);

        public static string ParseLinkerLog(string json)
        {
        ...
        public static LinkerGeometryPreparedPayload ParseLinkerGeometryPrepared(string json)
        {
            var dict = Deserialize(json);
            return new LinkerGeometryPreparedPayload
            {
    ...
    internal sealed class StartMatchingPayload
    {
        ...
        /// in the same order as the key columns sent in <c>linker-ready</c>.
        /// </summary>
    ...
    internal sealed class LinkerGeometryPreparedPayload
    {
        public string PdfId          { get; set; }
