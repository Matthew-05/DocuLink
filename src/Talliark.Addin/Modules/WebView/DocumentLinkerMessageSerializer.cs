...
{
    /// <summary>
    /// Serializes outbound host→document-linker JSON messages.
    /// </summary>
    internal static class DocumentLinkerMessageSerializer
    {
        /// <summary>
        ...
        /// </summary>
        public static string BuildLinkerReady(
            int rowCount,
        ...
        /// <summary>
        /// Sent when the Excel selection changes while the linker wizard is open.
        /// </summary>
        public static string BuildLinkerSelectionChanged(
            int rowCount,
            IList<KeyColumnEntry> keyColumns,
            IList<OutputColumnEntry> outputColumns)
        {
            var sb = new StringBuilder();
            sb.Append("{\"type\":\"linker-selection-changed\"");
            sb.Append(",\"rowCount\":"); sb.Append(rowCount);
        ...
        /// </summary>
        public static string BuildLinkerDataLoaded(
            IList<LinkerRowEntry> rows,
            IList<LinkerPdfEntry> pdfs)
        {
            var sb = new StringBuilder();
            sb.Append("{\"type\":\"linker-data-loaded\"");
        ...
        {
            return confirmed
                ? "{\"type\":\"linker-confirm-overwrite-result\",\"confirmed\":true}"
                : "{\"type\":\"linker-confirm-overwrite-result\",\"confirmed\":false}";
        }
    ...
    internal sealed class LinkerRowEntry
    {
        public int          RowIndex  { get; set; }
        public List<string> KeyValues { get; set; }
    }

    internal sealed class LinkerPdfEntry
    {
